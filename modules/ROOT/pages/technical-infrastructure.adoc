...
A l’apartat Repositori de
link:#repositori-de-codi-i-control-de-versions[codi i control de versions]
s’explica com crear la web de desenvolupament, que és l’única que es
necessita des de bon començament. A mida que el projecte creix, es pot
valorar si cal també un lloc orientat a d’altres perfils de participant.
...
[[repositori-de-codi-i-control-de-versions]]Per permetre finalment integrar
els nostres canvis, i que les nostres notificacions de defectes tinguin
sentit.
--
